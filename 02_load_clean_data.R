...
###################################################################################################################################
#Loading and cleaning earliest Age Composition data (no cwd test), prior to start of study
###################################################################################################################################
...
df_age_before <- df_age_before %>% group_by(age,sex) %>% summarise(total=sum(n))
df_age_before_male <- df_age_before %>% filter(sex == "Male")
df_age_before_female <- df_age_before %>% filter(sex == "Female")

# df_age_before_female$prop <- df_age_before_female$total/sum(df_age_before_female$total)
# df_age_before_male$prop <- df_age_before_male$total/sum(df_age_before_male$total)
